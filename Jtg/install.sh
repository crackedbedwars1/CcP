...
install_panel() {
    ...
    # Clone from GitHub
    git clone https://github.com/crackedbedwars1/CcP
    ...
    echo -e "${GREEN} MADE BY - rishab  | panel info  [Online] ${NC}"
    echo -e "${GREEN}==========================================${NC}"
...
while true; do
    echo -e "\n${YELLOW}========================================${NC}"
    echo -e "${GREEN}       CREEPERCLOUD PANEL MANAGER MENU (BADMOSHI NHI MITRRR)         ${NC}"
    echo -e "${YELLOW}========================================${NC}"
